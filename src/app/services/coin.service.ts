...
export class CoinService {
  ...
  getCoinMarket(coinId: string, currency: string, days: number): Observable<MarketChart> {
    ...
    return this.httpClient.get<MarketChart>(`${this.apiUrl}/${coinId}/market_chart`, { params });
  }
}
